...
class LittleBrain {
  ...
  enum littleBrainState {WAIT_FOR_BUTTON, TELEOP, 
    GRAB, EXTRACT, EXTRACT_1, BACKUP, BACKUP_1, TURN_AROUND, CHOOSE_STORAGE_RACK, LINE_FOLLOW_CROSSING, GO_A_BIT_FURTHER, TURN, LINE_FOLLOW_TO_PEG, INSERT_STORAGE, CHECK_INSERTION, RE_INSERT,
       DOUBLE_TAP_0, DOUBLE_TAP_1, DOUBLE_TAP_2, DOUBLE_TAP_3, DOUBLE_TAP_4, 
    // autnonomous storage to supply   
    REVERSE_FROM_STORAGE, REVERSE_FROM_STORAGE_1, AUTO_180, CHOOSE_PATH, GO_TO_CENTER, GO_TO_CENTER_1, TURN_TOWARDS,
