...
class LittleBrain {
  ...
  enum littleBrainState {WAIT_FOR_BUTTON, TELEOP, 
    ...
    A_REVERSE_FROM_STORAGE, A_PREP_REVERSE, A_REVERSE, A_PREP_180, A_DO_180, A_CHOOSE_PATH, A_GO_TO_CENTER, A_INIT_TURN_TOWARDS_1, A_TURN_TOWARDS_1, A_DRIVE_TO_NEXT_CROSSING, A_INIT_TURN_TO_SUPPLY, A_TURN_TO_SUPPLY, A_LINE_FOLLOW_TO_PEG,
